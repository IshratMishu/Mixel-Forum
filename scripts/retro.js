...
const discussionPosts = async() => {
    ...
    allData.forEach((item) => {
        ...
        <div class="indicator mt-10 lg:ml-5 mx-auto">
          ...
          <div class="grid w-32 lg:w-20 h-20 bg-base-300 place-items-center"><img src="images/logo.png" alt=""></div>
        </div>
        <div class="card-body p-1 lg:p-10">
          <div class="flex gap-3 lg:gap-10 font-medium text-sm text-color-gray80">
            <h5>#Music</h5>
            <h5>Author : Awlad Hossain</h5>
          </div>
          <h2 class="font-bold text-black text-xl">New movie is released!</h2>
          <p class="text-color-gray80 text-sm">Click the button to watch on Jetflix app.</p>
          ...
          <div class="flex justify-between">
            <div class="flex gap-4">
              <div class="flex items-center gap-2">
                ...
                <p class="text-color-gray60">560</p>
              </div>
              ...
              <div class="flex items-center gap-2">
               ...
               <p class="text-color-gray60">1,568</p> 
              </div>
              ...
              <div class="flex items-center gap-2">
               ...
               <p class="text-color-gray60">5 min</p> 
              </div>
            </div>
